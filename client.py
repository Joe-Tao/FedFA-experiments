...
def client_fedfa_cl(args, client_index, anchorloss_funcs, global_model, global_round, dataset_train, dict_users, loss_dict, masks, layer_list, global_list, shape_list):  # update nn
    ...
    for k in client_index: #k is the index of the client
        ...
        # Encryption on parameters
        temp = encrypt_by_para(args, layer_list[k], client_model, k, masks)
        layer_list[k] = temp
