...
class Server:
    ...
    def fedfa_anchorloss(self, testset, dict_users_test, mask, similarity=False, fedbn = False,
        ...
        for t in range(self.args.r):
            ...
            #joint updating to obtain personalzied model based on updating global model
            self.cls, self.nns, self.loss_dict, self.layer_list = client_fedfa_cl(self.args, index, self.cls, self.nn, t, self.dataset,  self.dict_users, self.loss_dict, mask, self.layer_list, self.global_layer_list, self.shape_list)
